...
<html lang="fr">
    <head>
        ...
        <meta name="description" content="TP 3 de CSS-CMS : Emailing">
        <title>MIW - Day 3</title>
        <link rel="stylesheet" type="text/css" href="css/style.css">
    </head>
    <body>
        <div class="container">
            <form action="#" method="post" class="waitingfor <?php echo $form ?>">
